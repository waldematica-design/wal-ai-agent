      ...
      <div className="mx-auto max-w-7xl px-5 py-8 sm:px-8">
        <header>
          ...
          <h1 className="mt-2 text-3xl font-bold tracking-tight">
            Leads do Agente IA Waldemática
          </h1>

          <p className="mt-2 text-sm text-slate-400">
            Interessados identificados automaticamente durante as conversas no waldematica.com.br.
          </p>
        </header>
            ...
            leads.map((lead) => {
              ...
              return (
                ...
                >
                  ...
                  <Link
                    href={`/admin/waldematica/leads/${lead.id}`}
